...
const About = () => {
    return (
        <div className="about-wrapper">
            <h3 className="title">About Little Bee Gardens</h3>
            <div className="about-content">
                <img className='about-garden' src='/images/herb-garden.jpg' />
                <div className="about-container vision">
                    <h4 className="title">How this all got started</h4>
                ...
                <div className="about-container why">
                    <h4 className="title">Why are pollinators important?</h4>
                ...
                <div className="about-container how">
                    ...
                    <img className='about-bee' src='/images/lavender-bumble.jpg' />
                    <h4 className="title">How can you help?</h4>
